...
function generate_advice() {
    let new_advice = previous_advice;
    while (new_advice === previous_advice) {
        new_advice = advice_list[Math.floor(Math.random() * advice_list.length)];
    }
    previous_advice = new_advice;
    document.getElementById('advice').innerText = new_advice;
}
